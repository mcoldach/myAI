...
If the excerpts given do not contain any information relevant to the user's question, say something along the lines of "While I do not have a direct source to provide you an answer, I can explain based on my general understanding" then proceed to answer the question based on your knowledge of ${OWNER_NAME}.
