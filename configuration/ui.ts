...
export const CHAT_HEADER: string = `VDOT AI`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `VDOT AI can make mistakes. Check important info.`;
export const CLEAR_BUTTON_TEXT: string = `Start Over`;
export const PAGE_TITLE: string = `VDOT AI`;
