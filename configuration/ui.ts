...
export const CHAT_HEADER: string = `IronTriangleAI`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `IronTriangleAI can make mistakes. Check important info.`;
export const CLEAR_BUTTON_TEXT: string = `Start Over`;
export const PAGE_TITLE: string = `IronTriangleAI`;
